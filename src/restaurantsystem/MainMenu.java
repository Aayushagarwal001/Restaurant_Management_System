...
public class MainMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(234, 136, 115));
        jPanel2.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));

        jPanel1.setBackground(new java.awt.Color(234, 136, 115));
        jPanel1.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jPanel1.setForeground(new java.awt.Color(234, 136, 115));

        orderManagementButton.setText("Order Management");
        orderManagementButton.setBackground(new Color(96, 198, 253));
        orderManagementButton.setForeground(new Color(0, 0, 0));
        ...
        labourManagementButton.setBackground(new Color(96, 198, 253));
        labourManagementButton.setForeground(new Color(0, 0, 0));
        ...
        itemManagementButton.setBackground(new Color(96, 198, 253));
        itemManagementButton.setForeground(new Color(0, 0, 0));
